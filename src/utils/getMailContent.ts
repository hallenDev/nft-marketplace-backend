...
export const getOutbidMailContent = (buyer, asset, asset_id, other_bidder) => {
    let _html = `
    <!DOCTYPE html>
    ...
    <tr>
    <td>
    <div align="center" style="line-height:10px"><a href="http://18.209.240.51" style="outline:none" tabindex="-1" target="_blank"><img alt="Logo" src="http://18.209.240.51/img/logo.PNG" style="display: block; height: auto; border: 0; width: 325px; max-width: 100%;" title="Logo" width="325"/></a></div>
    </td>
    </tr>
    </table>
    </td>
    ...
    <td>
    <div align="center">
        <a href="http://18.209.240.51/ItemDetail/${asset_id}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#fa63ff;border-radius:50px;width:auto;border-top:1px solid #fa63ff;font-weight:400;border-right:1px solid #fa63ff;border-bottom:1px solid #fa63ff;border-left:1px solid #fa63ff;padding-top:5px;padding-bottom:5px;font-family:Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:50px;padding-right:50px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>Place a new bid</strong></span></span></a>
    </div>
    </td>
    </tr>
    </table>
...
export const getAuctionEndedMailContent = (seller, asset, asset_id) => {
    let _html = `
    <!DOCTYPE html>
...
export const getAuctionMailContent = (buyer, asset, asset_id) => {
    let _html = `
    <!DOCTYPE html>
...
export const getOfferMailContent = (seller, offer, asset, url, price, asset_id) => {
    ...
    <div class="txtTinyMce-wrapper" style="font-size: 14px; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 21px; color: #555555; line-height: 1.5;">
            ...
            ${offer} made a offer of ${vxlPrice} VXL (${price} USD) on ${asset}. <br/>
...
export const getBidMailContent = (seller, bidder, asset, url, price, asset_id) => {
...
export const getAcceptMailContent = (seller, buyer, asset, price, asset_id, usdPrice) => {
...
export const getBuyMailContent = (seller, buyer, asset, price, usdPrice, asset_id) => {
    ...
    <div class="txtTinyMce-wrapper" style="font-size: 14px; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 21px; color: #555555; line-height: 1.5;">
            ...
            Congratulations! ${asset} was sold to ${buyer} for ${price} VXL (${usdPrice} USD).  <br/>
            Thank you for using <a dir="auto" href="http://superkluster.io/" rel="noopener noreferrer" style="color: #0068A5;" target="_blank" title="http://SuperKluster.io">SuperKluster.io</a>  <br/>
    </div>
    </div>
    </td>
    </tr>
...
export const getBuyerEmailContent = (seller, buyer, asset, price, asset_id, usdPrice) => {
    // this price is vxl price
    let _html = `
    <!DOCTYPE html>
    ...
    <div class="txtTinyMce-wrapper" style="font-size: 14px; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 21px; color: #555555; line-height: 1.5;">
            ...
            You puchased ${asset} from ${seller} for ${price} VXL (${usdPrice} USD). <br/>
            Thank you for using <a dir="auto" href="http://18.209.240.51" rel="noopener noreferrer" style="color: #0068A5;" target="_blank" title="http://18.209.240.51">SuperKluster.io</a>  <br/>
    </div>
    </div>
    </td>
    </tr>
